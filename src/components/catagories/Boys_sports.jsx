...
const Boys_sports = () => {
  const shoes = Array.from({ length: 30 }, (_, index) => ({
    id: index + 1,
    name: `Boys Sports Shoe ${index + 1}`,
    img: `https://via.placeholder.com/250?text=Boys+Shoe+${index + 1}`,
  }));

  return (
    <div className="container my-5">
      <h2 className="text-center fw-bold mb-4">Boys Sports Shoes Collection</h2>
      <div className="row">
        {shoes.map((shoe) => (
